...
* Clone the repository [https://github.com/timhjellum/boston-market---case-study](git clone https://github.com/timhjellum/boston-market---case-study.git)
* `cd boston-market---case-study`
* `npm install`
* `run npm start`